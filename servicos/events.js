...
eventsAPI.prototype.listGQL = function(){
	...
	var query = `query={events(type:EVENT ${q_filtro_mall}){ _id slug title short_description detailed_descrition start_at stop_at  ${q_store} ${q_mall} ${q_images}}}`;
	var resposta = "";
	var opcoes = {  
	    method: 'GET',
...
eventsAPI.prototype.montarGQL = function(resultados){
	var retorno = [];
...
eventsAPI.prototype.viewGQL = function(registro){
...
eventsAPI.prototype.montarViewGQL = function(obj){
	var nome_do_Shopping = "";
	var slug_shopping = "";
	if (obj.mall){
		var nome_do_Shopping = obj.mall.name;
